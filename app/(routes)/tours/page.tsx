const ToursPage = () => {
  return (
    <div>
      <div className="text-5xl text-center uppercase mt-20">
        Alla spelningar
      </div>
      <div className="w-full flex-1 max-w-screen-sm mx-auto text-center">
        ...
        Lördag 13 maj, Bierkeller Västerås (Bordsbokning: 021 80 02 00) <br />
        ...
        Lördag 26 augusti kl. 20:45: Bierkeller Västerås (Bordsbokning: 021 80
        02 00) <br />
        Fredag 22 september o Lördag 23 september: Horten (Blues&apos;n), Norge.{" "}
        <br />
        ...
        spelning! <br />
        Lördag 29 oktober kl. 20:45, Bierkeller Västerås (Bordsbokning: 021 80
        02 00) <br />
        Fredag 14/10 och Lördag 15/10, Bluesn Horten Norge. <br />
        Lördag 29/10 kl. 20:45, Bierkeller Västerås (Bordsbokning: 021 80 02 00){" "}
        <br />
        ...
        Söndag 10 oktober, Konstföreningen, Västerås.Lördag 16 oktober: Blues At
        Eskilstuna - http://www.julymorning.nu <br />
        ...
        Söndag 17 maj kl. 17:00, Västerås Konsthall: www.konstnarsforeningen.com
        (INSTÄLLD PGA CORONA) <br />
        <div className="text-2xl font-semibold mt-8">2019</div>
        Vi har fullt upp med inspelning av nytt material till vår 3:e CD <br />
        ...
        10 mars, Borlänge House of Blues http:/http://www.dalablueskollektiv.se/{" "}
        <br />
        ...
        11 juli, Sätra Brunn https://satrabrunn.se10 augusti, Smedens BBQ Ramnäs
        https://www.smedensbbq.se/ <br />
        25 augusti, TFG FESTIVAL, Skinnskatteberg <br />
        31 augusti, Västerås Officersmäss : http://www.vasterasofficersmass.se{" "}
        <br />
        ...
        http://www.bluechain.se) OBS! SPELNINGEN TYVÄRR INSTÄLLD P.G.A. SJUKDOM!{" "}
        <br />
